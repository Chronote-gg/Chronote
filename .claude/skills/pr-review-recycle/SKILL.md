---
name: pr-review-recycle
description: Use to process automated PR review feedback (Copilot, Greptile, Codex) and iterate until all AI threads are addressed, checks are green, and the PR is merge-ready. Trigger when the user says "address review feedback", "recycle reviews", or references an automated reviewer.
---

# PR Review Recycle Loop

Use this skill when you need to process automated PR review feedback (Copilot,
Greptile, Codex) and iterate until:
...
Claude Code mirror of `.opencode/skills/pr-review-recycle/SKILL.md` and exists

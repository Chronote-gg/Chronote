...
- Transcription prompt is Langfuse-managed (`chronote-transcription-prompt`). Guardrails include a loudness gate (noise gate metrics, hard silence threshold, and logprobs) and a prompt echo gate.
...
- Transcription guardrails include a loudness gate (noise gate metrics, hard silence threshold, and logprobs) and a prompt echo gate using similarity checks.

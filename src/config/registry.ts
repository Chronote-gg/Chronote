...
export const CONFIG_REGISTRY: ConfigEntry[] = [
  ...
  },
  {
    ...
    label: "Recording nickname suffix",
    description: "Suffix appended to the bot name while recording a meeting.",
    category: "Chat TTS",
    group: "Advanced",
    valueType: "string",
    ...
    ui: { type: "text", placeholder: "(Recording)" },
  },
  {
    key: "chatTts.statusNickname.ttsOnly",
    label: "TTS-only nickname suffix",
    description:
      "Suffix appended to the bot name while in a TTS-only voice session.",
    category: "Chat TTS",
    group: "Advanced",
    valueType: "string",
    ...
    ui: { type: "text", placeholder: "(TTS Only)" },
  },
  {

...
const meta: Meta<typeof UpgradeSuccessHero> = {
  ...
  args: {
    ...
    promoCode: "SAVE20",
    openPortalPath: "/portal/server/1234567890/library",
    billingPath: "/portal/server/1234567890/billing",
    plan: "pro",
    interval: "year",
  },
};
...
export const ConnectDiscordState: Story = {
  args: {
    ...
    promoCode: "",
    openPortalPath: "/portal/select-server",
    billingPath: "/portal/select-server",
    plan: undefined,
    interval: undefined,
  },
};

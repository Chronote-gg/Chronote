...
| The account that installed Chronote in a server and, when installation began from our website, its sanitized acquisition source, medium, campaign, landing-page category, referring domain, and button location                                                                               | DynamoDB                                              |
...
| PostHog             | Product analytics for the website and web portal, installation-source reporting, and what you do with Chronote in Discord. See the analytics section below for what this covers                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
